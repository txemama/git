...
public class BotonesMensajesMenuBarra extends JFrame implements ActionListener{
	...
	public BotonesMensajesMenuBarra() {
		setTitle("BotonesMensajesMenuBarra");
		...
		tbHola.setIcon(new ImageIcon(BotonesMensajesMenuBarra.class.getResource("/iconos/nuevo.gif")));
		toolBar.add(tbHola);
		
		tbAdios = new JButton("Adios");
		tbAdios.addActionListener(this);
		tbAdios.setIcon(new ImageIcon(BotonesMensajesMenuBarra.class.getResource("/iconos/guardar.gif")));
		toolBar.add(tbAdios);
		
		tbKaixo = new JButton("Kaixo");
		tbKaixo.addActionListener(this);
		tbKaixo.setIcon(new ImageIcon(BotonesMensajesMenuBarra.class.getResource("/iconos/guardarcomo.gif")));
		toolBar.add(tbKaixo);
		
		tbAgur = new JButton("Agur");
		tbAgur.addActionListener(this);
		tbAgur.setIcon(new ImageIcon(BotonesMensajesMenuBarra.class.getResource("/iconos/abrir.gif")));
		toolBar.add(tbAgur);
